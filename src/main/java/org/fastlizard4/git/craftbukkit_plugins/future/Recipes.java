...
public final class Recipes {
    ...
    public static List<Recipe> getRecipes() {
        return ImmutableList.of(getPackedIceRecipe());
    }

    private static Recipe getPackedIceRecipe() {
        ItemStack packedIce = new ItemStack(Material.PACKED_ICE, 1);
        ShapedRecipe packedIceRecipe = new ShapedRecipe(packedIce);
        packedIceRecipe.shape("iii", "iii", "iii");
        packedIceRecipe.setIngredient('i', Material.ICE);

        return packedIceRecipe;
    }
}
